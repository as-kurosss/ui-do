  ...
  useEditorStore.setState({
    project: {
      ...
      screens: [{
        ...
        root: {
          kind: 'layout', id: 'root' as never, display: 'flex', direction: 'column',
          gap: 4, align: 'stretch', className: 'min-h-screen',
          children: [
            { kind: 'component', id: 'b1' as never, component: 'Button' },
            {
              kind: 'layout', id: 'inner' as never, display: 'flex', children: [
