...
import { mapNode, insertNode, removeNode, moveNode, findNode, createDefaultRoot, wrapNode, ungroupChildren } from './tree'
...
const root: LayoutNode = makeLayout('root', [
  btn,
  makeLayout('inner', [input, text]),
])
